...
% ===================
  ...
  cassistsupervisor = {马龙~~研究员}, % 本科生可选，助理指导教师姓名，不用时请留空{}，与下一项一起至多只用其一
  cextrasupervisor = {菲尔普斯~~副教授}, % 本科生可选，校外指导教师姓名，不用时请留空{}，与上一项一起至多只用其一
  eassistsupervisor = {Prof.~Long~Ma}, % 本科生可选，助理指导教师或校外指导教师姓名拼音，和上两项中一项对应，不用时请留空{}
