...
这是 \cquthesis{} 的示例文档，基本上覆盖了模板中所有格式的设置。建议大家在使用模
板之前，除了阅读《\cquthesis{}用户手册》，这个示例文档也最好能看一看。
...
\begin{table}[htbp]
 ...
 \multirow{2}*{\diagbox[width=5em]{x}{y}} & \multicolumn{2}{c|}{First Half} & \multicolumn{2}{c|}{Second Half}\\\cline{2-5}
    ...
    \end{tabularx}\\[2pt]
    \footnotesize 注：数据来源《\cquthesis{} 使用手册》。\\
    *：东部\\
    **：西部
  \end{minipage}
\end{table}
...
\begin{table}[htbp]
  ...
  \begin{tabular}[c]{|m{1.5cm}|c|c|c|c|c|c|}\hline
    ...
    \multirow{2}{1.5cm}{Xue} & Rui  & Ni &\multicolumn{4}{c|}{\multirow{2}*{\cquthesis}}\\\cline{2-3}
