...
# Idea form latex3 Team Github Repo, many thanks!
#
...
if ! command -v texlua > /dev/null; then
  ...
  ./install-tl --profile=../toolkit/texlive.profile
...
# Additional requirements for (u)pLaTeX, done with no dependencies to avoid large font payloads
