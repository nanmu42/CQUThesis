...
\end{denotation}
	...
	\begin{figure}[th]
	\centering
	\includegraphics{figures/crossmark}
	\caption[测试用图]{这幅图是一个测试用图，这个说明是一个很长的说明，这是两个事情。}
	\label{fig:crossmark}
	\end{figure}

	
	\chapter{致\hskip\ccwd{}谢}	% 致谢之间空两个汉字
	表明了，\eqref{eq:dd}这个模板是站在巨人肩膀上的成果，感谢\LaTeXe{}计划，感谢CTeX开发组提供的中文解决方案，感谢薛瑞尼副教授(Github: xueruini/ThuThesis)，感谢WeiJianWen同学(Github: weijianwen/SJTUThesis)，感谢中国科学技术大学TeX用户组(Github: ustctug/gbt-7714-2015)。向你们致以真诚的问候和感激。\ref{fig:crossmark}表示了……\speakyourlove
	...
	English?\inlinecite{r5}
	English?\onlinecite{r7,r8,r9}
	
	中文参考文献。\cite{z2}
	
	文献\onlinecite{z1,z3}中提到……
